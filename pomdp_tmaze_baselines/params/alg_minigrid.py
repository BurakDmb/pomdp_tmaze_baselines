...
minigrid_learning_setting['intrinsic_beta'] = 0.5
minigrid_learning_setting['autoencoder_enabled'] = True
minigrid_learning_setting['autoencoder_path'] = "models/ae.torch"
