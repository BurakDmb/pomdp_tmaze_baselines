...
start_cnn_smm_lastk = False
start_cnn_smm_bk = True
start_cnn_smm_ok = True
start_cnn_smm_oak = True
start_cnn_lstm = True
...
mgrid_cnn_smm_lastk_setting = {}
mgrid_cnn_smm_lastk_setting['envClass'] = envClass
mgrid_cnn_smm_lastk_setting['learning_rate'] = learning_rate
mgrid_cnn_smm_lastk_setting['discount_rate'] = discount_rate
mgrid_cnn_smm_lastk_setting['nn_num_layers'] = nn_num_layers
mgrid_cnn_smm_lastk_setting['nn_layer_size'] = nn_layer_size
mgrid_cnn_smm_lastk_setting['n_steps'] = n_steps
mgrid_cnn_smm_lastk_setting['batch_size'] = batch_size
mgrid_cnn_smm_lastk_setting['memory_type'] = 1
mgrid_cnn_smm_lastk_setting['memory_length'] = 1
mgrid_cnn_smm_lastk_setting['intrinsic_enabled'] = False
mgrid_cnn_smm_lastk_setting['intrinsic_beta'] = 0.01
mgrid_cnn_smm_lastk_setting['ae_enabled'] = False
mgrid_cnn_smm_lastk_setting['ae_path'] = "models/ae.torch"
mgrid_cnn_smm_lastk_setting['ae_rcons_err_type'] = "MSE"
mgrid_cnn_smm_lastk_setting['eval_enabled'] = False
mgrid_cnn_smm_lastk_setting['eval_freq'] = 1000
mgrid_cnn_smm_lastk_setting['eval_episodes'] = 0
mgrid_cnn_smm_lastk_setting['eval_path'] = None
mgrid_cnn_smm_lastk_setting['tb_log_name'] = "cnn_smm_lastk"
mgrid_cnn_smm_lastk_setting['tb_log_dir'] = "./logs/c_minigrid_tb/"
mgrid_cnn_smm_lastk_setting['maze_length'] = maze_length
mgrid_cnn_smm_lastk_setting['total_timesteps'] = total_timesteps
mgrid_cnn_smm_lastk_setting['seed'] = None
mgrid_cnn_smm_lastk_setting['policy'] = CNNACPolicy
mgrid_cnn_smm_lastk_setting['save'] = True
mgrid_cnn_smm_lastk_setting['device'] = 'cuda:0'
mgrid_cnn_smm_lastk_setting['train_func'] = train_ppo_agent


mgrid_cnn_smm_bk_setting = {}
mgrid_cnn_smm_bk_setting['envClass'] = envClass
mgrid_cnn_smm_bk_setting['learning_rate'] = learning_rate
mgrid_cnn_smm_bk_setting['discount_rate'] = discount_rate
mgrid_cnn_smm_bk_setting['nn_num_layers'] = nn_num_layers
mgrid_cnn_smm_bk_setting['nn_layer_size'] = nn_layer_size
mgrid_cnn_smm_bk_setting['n_steps'] = n_steps
mgrid_cnn_smm_bk_setting['batch_size'] = batch_size
mgrid_cnn_smm_bk_setting['memory_type'] = 2
mgrid_cnn_smm_bk_setting['memory_length'] = 1
mgrid_cnn_smm_bk_setting['intrinsic_enabled'] = False
mgrid_cnn_smm_bk_setting['intrinsic_beta'] = 0.01
mgrid_cnn_smm_bk_setting['ae_enabled'] = False
mgrid_cnn_smm_bk_setting['ae_path'] = "models/ae.torch"
mgrid_cnn_smm_bk_setting['ae_rcons_err_type'] = "MSE"
mgrid_cnn_smm_bk_setting['eval_enabled'] = False
mgrid_cnn_smm_bk_setting['eval_freq'] = 1000
mgrid_cnn_smm_bk_setting['eval_episodes'] = 0
mgrid_cnn_smm_bk_setting['eval_path'] = None
mgrid_cnn_smm_bk_setting['tb_log_name'] = "cnn_smm_bk"
mgrid_cnn_smm_bk_setting['tb_log_dir'] = "./logs/c_minigrid_tb/"
mgrid_cnn_smm_bk_setting['maze_length'] = maze_length
mgrid_cnn_smm_bk_setting['total_timesteps'] = total_timesteps
mgrid_cnn_smm_bk_setting['seed'] = None
mgrid_cnn_smm_bk_setting['policy'] = CNNACPolicy
mgrid_cnn_smm_bk_setting['save'] = True
mgrid_cnn_smm_bk_setting['device'] = 'cuda:0'
mgrid_cnn_smm_bk_setting['train_func'] = train_ppo_agent

mgrid_cnn_smm_ok_setting = {}
mgrid_cnn_smm_ok_setting['envClass'] = envClass
mgrid_cnn_smm_ok_setting['learning_rate'] = learning_rate
mgrid_cnn_smm_ok_setting['discount_rate'] = discount_rate
mgrid_cnn_smm_ok_setting['nn_num_layers'] = nn_num_layers
mgrid_cnn_smm_ok_setting['nn_layer_size'] = nn_layer_size
mgrid_cnn_smm_ok_setting['n_steps'] = n_steps
mgrid_cnn_smm_ok_setting['batch_size'] = batch_size
mgrid_cnn_smm_ok_setting['memory_type'] = 3
mgrid_cnn_smm_ok_setting['memory_length'] = 1
mgrid_cnn_smm_ok_setting['intrinsic_enabled'] = False
mgrid_cnn_smm_ok_setting['intrinsic_beta'] = 0.01
mgrid_cnn_smm_ok_setting['ae_enabled'] = False
mgrid_cnn_smm_ok_setting['ae_path'] = "models/ae.torch"
mgrid_cnn_smm_ok_setting['ae_rcons_err_type'] = "MSE"
mgrid_cnn_smm_ok_setting['eval_enabled'] = False
mgrid_cnn_smm_ok_setting['eval_freq'] = 1000
mgrid_cnn_smm_ok_setting['eval_episodes'] = 0
mgrid_cnn_smm_ok_setting['eval_path'] = None
mgrid_cnn_smm_ok_setting['tb_log_name'] = "cnn_smm_ok"
mgrid_cnn_smm_ok_setting['tb_log_dir'] = "./logs/c_minigrid_tb/"
mgrid_cnn_smm_ok_setting['maze_length'] = maze_length
mgrid_cnn_smm_ok_setting['total_timesteps'] = total_timesteps
mgrid_cnn_smm_ok_setting['seed'] = None
mgrid_cnn_smm_ok_setting['policy'] = CNNACPolicy
mgrid_cnn_smm_ok_setting['save'] = True
mgrid_cnn_smm_ok_setting['device'] = 'cuda:0'
mgrid_cnn_smm_ok_setting['train_func'] = train_ppo_agent

mgrid_cnn_smm_oak_setting = {}
mgrid_cnn_smm_oak_setting['envClass'] = envClass
mgrid_cnn_smm_oak_setting['learning_rate'] = learning_rate
mgrid_cnn_smm_oak_setting['discount_rate'] = discount_rate
mgrid_cnn_smm_oak_setting['nn_num_layers'] = nn_num_layers
mgrid_cnn_smm_oak_setting['nn_layer_size'] = nn_layer_size
mgrid_cnn_smm_oak_setting['n_steps'] = n_steps
mgrid_cnn_smm_oak_setting['batch_size'] = batch_size
mgrid_cnn_smm_oak_setting['memory_type'] = 4
mgrid_cnn_smm_oak_setting['memory_length'] = 1
mgrid_cnn_smm_oak_setting['intrinsic_enabled'] = False
mgrid_cnn_smm_oak_setting['intrinsic_beta'] = 0.01
mgrid_cnn_smm_oak_setting['ae_enabled'] = False
mgrid_cnn_smm_oak_setting['ae_path'] = "models/ae.torch"
mgrid_cnn_smm_oak_setting['ae_rcons_err_type'] = "MSE"
mgrid_cnn_smm_oak_setting['eval_enabled'] = False
mgrid_cnn_smm_oak_setting['eval_freq'] = 1000
mgrid_cnn_smm_oak_setting['eval_episodes'] = 0
mgrid_cnn_smm_oak_setting['eval_path'] = None
mgrid_cnn_smm_oak_setting['tb_log_name'] = "cnn_smm_oak"
mgrid_cnn_smm_oak_setting['tb_log_dir'] = "./logs/c_minigrid_tb/"
mgrid_cnn_smm_oak_setting['maze_length'] = maze_length
mgrid_cnn_smm_oak_setting['total_timesteps'] = total_timesteps
mgrid_cnn_smm_oak_setting['seed'] = None
mgrid_cnn_smm_oak_setting['policy'] = CNNACPolicy
mgrid_cnn_smm_oak_setting['save'] = True
mgrid_cnn_smm_oak_setting['device'] = 'cuda:0'
mgrid_cnn_smm_oak_setting['train_func'] = train_ppo_agent
...
mgrid_cnn_lstm_setting['memory_type'] = 5
...
mgrid_cnn_lstm_setting['eval_enabled'] = False
mgrid_cnn_lstm_setting['eval_freq'] = 1000
mgrid_cnn_lstm_setting['eval_episodes'] = 0
mgrid_cnn_lstm_setting['eval_path'] = None
