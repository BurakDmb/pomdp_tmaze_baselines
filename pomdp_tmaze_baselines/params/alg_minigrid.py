...
eval_freq = (total_timesteps // 200) // env_n_proc
intrinsic_beta = 0.05

n_steps = 32
batch_size = n_steps  # Full batch iteration

ae_path = "models/ae.torch_binary"
ae_shared = True
